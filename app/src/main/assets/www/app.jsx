...
/**
 * Root React application component that renders the app shell, navigation tabs, and the Monitor/Dashboard/Settings screens while managing ingestion of tracker data.
 *
 * Sets up global integration hooks (reads window.Android status, exposes window.reactDataCallback, and processes window.injectedJsonData) and derives sanitized session and timeline data passed into child screens.
 *
 * @returns {JSX.Element|null} The root JSX element for the app shell and its screens, or null if no data is available.
 */
